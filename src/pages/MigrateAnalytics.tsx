...
const MigrateAnalytics = () => {
  ...
  const generateHistoricalData = () => {
    // Transform Lovable Analytics data: estimate pageviews as visitors × 1.5
    return lovableAnalyticsData.map(day => ({
      date: day.date,
      visitors: day.visitors,
      pageviews: Math.round(day.visitors * 1.5),
    }));
  };
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Import 117 days of historical data (July 7 - October 31, 2024) with 144,865 total visitors
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="text-sm text-muted-foreground space-y-2">
              ...
              <ul className="list-disc list-inside space-y-1">
                ...
                <li>Date range: July 7 - October 31, 2024</li>
                <li>Total of 144,865 visitors</li>
