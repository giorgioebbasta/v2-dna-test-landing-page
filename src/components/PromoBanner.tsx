...
const PromoBanner = () => {
  ...
  return <div className={cn("fixed top-[42px] md:top-[49px] left-0 right-0 z-40 px-4 shadow-lg", paddingClass, colorScheme.textColor)} style={{
    ...
    ...colorScheme.style
      ...
      <div className="max-w-7xl mx-auto text-center">
        <p className="font-bold text-base md:text-lg">
          ...
          <span className="hidden md:inline">Dicembre - Regala il Test del DNA €300 di sconto</span>
        </p>
      </div>
    </div>;
};
