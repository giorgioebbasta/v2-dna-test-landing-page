    ...
    <>
      ...
      <section id="intro" className="scroll-mt-32 pt-16 md:pt-24 lg:pt-32 pb-8 md:pb-16 lg:pb-20 md:px-6 bg-[#F8FAFA]">
        <div className="max-w-4xl md:mx-auto text-center space-y-4 md:space-y-6 px-4 md:px-0">
          ...
          <Button size="lg" className="bg-[#BAC0C4] hover:bg-[#2F3F4C] text-[#0A121A] hover:text-white text-sm sm:text-base md:text-lg lg:text-xl px-6 md:px-8 py-4 md:py-6 w-full md:w-auto transition-all duration-200" asChild>
      ...
      <section id="evidenze" className="scroll-mt-32 py-8 md:py-16 lg:py-20 md:px-6 bg-[#F8FAFA]">
        <div className="max-w-4xl md:mx-auto space-y-6 md:space-y-8 px-4 md:px-0">
          ...
          <FigureCaption number={5} source="Grafico glicemico: due curve con andamento opposto (Fonte: Cell Metabolism, 2015 – Zeevi E. et al.)">
            <div className="rounded-lg overflow-hidden shadow-lg">
        ...
        <div className="max-w-4xl md:mx-auto space-y-6 md:space-y-8 px-4 md:px-0">
          ...
          <div className="bg-[#F8FAFA] rounded-lg p-6 md:p-8 space-y-4 border-2 border-[#0A121A] mt-8">
            ...
            <div className="flex justify-center pt-2">
              <Button size="lg" className="bg-[#BAC0C4] hover:bg-[#2F3F4C] text-[#0A121A] hover:text-white text-sm sm:text-base md:text-lg lg:text-xl px-8 py-6 w-full md:w-auto transition-all duration-200" asChild>
                <a href="#cta-section">Scopri come funziona la nutrizione personalizzata</a>
              </Button>
            </div>
            
            <FigureCaption number={7} source="Alimenti naturali con overlay di data points per evocare rigore scientifico">
      ...
      <section id="conclusioni" className="scroll-mt-32 py-8 md:py-16 lg:py-20 md:px-6">
        <div className="max-w-4xl md:mx-auto space-y-6 md:space-y-8 px-4 md:px-0">
          ...
          <FigureCaption number={9} source="Esperienze illustrative di percorsi personalizzati">
            <div className="rounded-lg overflow-hidden shadow-lg">
              <img src={womanWellness} alt="Rappresentazione di esperienze positive con la nutrizione personalizzata" className="w-full h-auto" loading="lazy" />
            </div>
          </FigureCaption>
        </div>
      </section>
      ...
      <section id="cta-section" className="scroll-mt-32 py-12 md:py-16 lg:py-20 md:px-6 bg-gradient-to-br from-[#E8FFC9] to-[#d4f5b1]">
        <div className="max-w-4xl md:mx-auto text-center space-y-6 px-4 md:px-0">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-4">
            <Button size="lg" className="bg-[#BAC0C4] hover:bg-[#2F3F4C] text-[#0A121A] hover:text-white text-sm sm:text-base md:text-lg lg:text-xl px-8 py-6 w-full sm:w-auto font-semibold transition-all duration-200" asChild>
          ...
          <div className="pt-6">
            <img src={womanWellness} alt="Donna sorridente che rappresenta equilibrio e benessere" className="w-full max-w-2xl mx-auto rounded-lg shadow-xl" loading="lazy" />
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl md:mx-auto space-y-8 px-4 md:px-0">
          ...
          <div className="pt-6 border-t border-[#EAEAEA]">
            <p className="text-xs text-[#768289] leading-relaxed">
              <strong>Disclaimer:</strong> Questo articolo ha finalità divulgative. Le informazioni qui riportate non sostituiscono il parere medico e si basano su fonti scientifiche pubbliche e aggiornate.
            </p>
          </div>
        </div>
      </section>
