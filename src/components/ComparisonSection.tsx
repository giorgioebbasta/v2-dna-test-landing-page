  ...
  return <section id="comparison-section" className="px-4 bg-gradient-to-b from-white to-slate-50 pt-4 pb-12">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mt-8">
          <Card className="inline-block border-0 shadow-xl" style={{ background: 'linear-gradient(to right, #D0C5FB, #A78BFA)', color: '#DCFE54' }}>
            <CardContent className="p-6">
              <div className="space-y-2">
                <p className="text-lg font-medium">Risparmia con Holifya</p>
                <p className="text-4xl font-bold">oltre €{totalSavings}</p>
                <div className="leading-relaxed" style={{ color: '#DCFE54' }}>
