...
const HeroBanner = React.memo(() => {
  ...
  return <div className="space-y-2 pt-2">
    ...
    }} className="text-[15px] md:text-[17px] lg:text-xl text-slate-600 leading-relaxed cursor-pointer hover:text-emerald-600 active:text-emerald-700 active:scale-95 hover:scale-105 transition-all duration-200 touch-manipulation select-none px-[7px]">
