...
const HeroBanner = React.memo(() => {
  ...
  return <div className="space-y-2 pt-2">
      ...
      <h1 className="text-[46px] md:text-[47px] lg:text-6xl font-bold text-slate-900 leading-tight">
      ...
      <p className="text-[18px] md:text-[17px] lg:text-xl text-slate-600 leading-relaxed cursor-pointer hover:text-emerald-600 active:text-emerald-700 active:scale-95 hover:scale-105 transition-all duration-200 touch-manipulation select-none" onClick={scrollToComparison} role="button" tabIndex={0} onKeyDown={e => {
