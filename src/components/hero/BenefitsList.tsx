...
const BenefitsList = React.memo(() => {
  return <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      {/* Trustpilot Box */}
      <a href="https://it.trustpilot.com/review/holifya.com" target="_blank" rel="noopener noreferrer" className="flex flex-nowrap items-center justify-center gap-3 hover:opacity-80 transition-opacity cursor-pointer">
        <div className="flex items-center gap-2">
          <div className="flex gap-0.5">
            {[...Array(5)].map((_, i) => <Star key={i} className="w-5 h-5 fill-[#00B67A] text-[#00B67A]" />)}
          </div>
