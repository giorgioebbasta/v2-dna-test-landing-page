...
(function() {
    ...
    // Get referral code from URL (Klaviyo coupon)
    function getReferralCode() {
        const urlParams = new URLSearchParams(window.location.search);
        // Read the 'code' parameter that contains Klaviyo-generated coupon
        const code = urlParams.get('code');
        
        if (code) {
            return code; // Return Klaviyo coupon code (e.g., CONDIVIDI_DNA_ABC123)
        }
        
        // Fallback if no code in URL
        return 'CONDIVIDI_DNA';
    }
